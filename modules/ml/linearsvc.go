...
func NewLinearSVCModule() *LinearSVCModule {
	return &LinearSVCModule{
		TCPModelPath: "https://raw.githubusercontent.com/wiki/nikofil/go-dpi/2grams_tcp.model",
		UDPModelPath: "https://raw.githubusercontent.com/wiki/nikofil/go-dpi/2grams_udp.model",
		Threshold:    0.8,
	}
}
